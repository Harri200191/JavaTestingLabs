...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
        ...
        // If not written by yourself, apply the collaboration policy rules
        if (!writtenByYourself) {
            // You may use code if it is available to everyone, and was not written as course work
            if (availableToOthers && !writtenAsCourseWork) {
                return true;
            }

            // You may use code if it was written as course work, but you must cite your source
            if (writtenAsCourseWork && citingYourSource) {
                return true;
            }

            // If implementation is required, you cannot use any code not written by yourself
            if (implementationRequired) {
                return false;
            }
        }
        
        // In all other cases, usage is not allowed
        return false;
    }
